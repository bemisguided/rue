...
export default class ContainerManager {
  ...
  addContainerEntry(name: string, resolver: ContainerEntryResolver, dependencies: ?Array<string>, singleton?: boolean, profiles: ?Array<string>): ContainerEntry {
    if (singleton === undefined || singleton === null) {
      singleton = true;
    }
    let containerEntry = new ContainerEntry(name, resolver, singleton, dependencies);
    if (!profiles) {
