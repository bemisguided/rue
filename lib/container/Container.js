...
export default class Container {
  ...
  replaceInstance(name: string, replacement: any, parentName: ?string): any {
    ...
    if (parentName) {
      let injectableEntry = this.dependencyProcessor.resolve(parentName);
      if (!injectableEntry) {
        throw new RueError('Dependency is not found: name=' + parentName);
      }
...
function _activateInjectableEntry(container: Container, injectableEntry: InjectableEntry): Promise<Array<any>> {
