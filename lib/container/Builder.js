...
export default class Builder {
  ...
  withDependencies(...dependencyNames: Array<string>): Builder {
    if (dependencyNames && (new Set(dependencyNames)).size !== dependencyNames.length) {
      throw new RueError('Dependency names cannot contain duplicates');
    }
    this.dependencyNames = dependencyNames;
    return this;
  }

  withFilter(filter: PreInjectionFilter): Builder {
    this.filter = filter;
    return this;
  }
