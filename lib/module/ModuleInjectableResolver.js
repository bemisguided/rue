...
export default class ModuleInjectableResolver extends InjectableResolver {
  ...
  constructor(module: any, lifecycle: InjectableLifecycleConfig) {
    super();
    this.module = module;
  ...
  resolve(name: string, dependencies: Array<any>): Promise<any> {
    try {
      ...
      let result = Reflect.apply(fn, this.module, dependencies);
      if (!PromiseHelper.isPromise(result)) {
        return PromiseHelper.wrapResolved(this.module);
      }
      return result
        .then(() => {
          return PromiseHelper.wrapResolved(this.module);
